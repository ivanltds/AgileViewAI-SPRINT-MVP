...
export function getSeverityIcon(sev) {
  const m = {
    critical: { svg: ICONS.critical, c: 'var(--red)' },
    warning:  { svg: ICONS.warning,  c: 'var(--amber)' },
    info:     { svg: ICONS.info,     c: 'var(--blue)' },
    ok:       { svg: ICONS.ok,       c: 'var(--green)' }
  };
